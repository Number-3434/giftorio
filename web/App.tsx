...
function App({ worker }: { worker: Worker }) {
  ...
  return (
    <>
      ...
      {isMobile() && <div class="mobile-warning">⚠️ GIFtorio works best on desktop devices. Some features may be limited on mobile.</div>}
              ...
              <div class="mt-5 mb-4 flex items-center justify-between">
                <label class="text-white-500" for="maxsize">
                  ...
                  <span class="tooltip">
                    ...
                    <br />
                    <br />
                    Larger values create higher resolution blueprints but take longer to generate and import, and can negatively impact on
                    game performance.
                    <br />
                    <br />
            ...
            <div class="progress-container" ref={(el) => (formRefs.progressContainer = el)} id="progressContainer">
              ...
              <div class="progress-bar-container">
                <div class="progress-bar-wrapper">
                  <div ref={(el) => (formRefs.progressBar = el)} id="progressBar" class="progress-bar" style="width: 0%"></div>
                </div>
              </div>
            </div>
            <div
    ...
    return (
      <div class="mb-1 flex">
        <label class="checkbox-label">
          <input type="checkbox" class="sr-only" checked={!!formData[key]} onChange={(e) => setFormData(key, e.currentTarget.checked)} />
